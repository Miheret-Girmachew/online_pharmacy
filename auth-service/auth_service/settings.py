...
SECRET_KEY = 'django-insecure-1nbi=pvh_pp$llmmp7dh7jibqv1x!5g$%pdfq$*b7(8w4x-n--'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST', 'db'),  # 'db' for Docker service name
...
ALLOWED_HOSTS = ['*']  # For dev only; in prod, specify domains like ['yourdomain.com']
